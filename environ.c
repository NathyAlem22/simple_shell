 ...
 * Return: the value
 */
char *_getenva(info_t *info, const char *name)
{
 ...
 * Return: Always 0
 */
int populate_enva_list(info_t *info)
{
	list_t *node = NULL;
	size_t i;
